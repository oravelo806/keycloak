...
import static com.pulse.auth.provider.user.CustomUserStorageProviderConstants.*;
...
public class CustomUserStorageProviderFactory
    ...
    public CustomUserStorageProviderFactory() {
        ...
        .property()
            ...
            .label("Database User")
            .type(ProviderConfigProperty.STRING_TYPE)
            .helpText("Username userd to connect to the database")
            .add()
        .property()
    ...
    @Override
    public List<ProviderConfigProperty> getConfigProperties() { return configMetadata; }
